...
namespace CrmSvcUtilExtensions.Crm.Entities
{
	...
	public partial class Contact : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<CrmSvcUtilExtensions.Crm.Entities.ContactState> StateCode
		{
			get
			{
				...
				if ((optionSet != null))
				{
					return ((CrmSvcUtilExtensions.Crm.Entities.ContactState)(System.Enum.ToObject(typeof(CrmSvcUtilExtensions.Crm.Entities.ContactState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Collections.Generic.IEnumerable<CrmSvcUtilExtensions.Crm.Entities.Contact> Referencedcontact_customer_contacts
		{
			get
			{
				return this.GetRelatedEntities<CrmSvcUtilExtensions.Crm.Entities.Contact>("contact_customer_contacts", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			set
			{
				this.OnPropertyChanging("Referencedcontact_customer_contacts");
				this.SetRelatedEntities<CrmSvcUtilExtensions.Crm.Entities.Contact>("contact_customer_contacts", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
		...
		public System.Collections.Generic.IEnumerable<CrmSvcUtilExtensions.Crm.Entities.Contact> Referencedcontact_master_contact
		{
			get
			{
				return this.GetRelatedEntities<CrmSvcUtilExtensions.Crm.Entities.Contact>("contact_master_contact", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			set
			{
				this.OnPropertyChanging("Referencedcontact_master_contact");
				this.SetRelatedEntities<CrmSvcUtilExtensions.Crm.Entities.Contact>("contact_master_contact", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
		...
		public CrmSvcUtilExtensions.Crm.Entities.Contact Referencingcontact_customer_contacts
		{
			get
			{
				return this.GetRelatedEntity<CrmSvcUtilExtensions.Crm.Entities.Contact>("contact_customer_contacts", Microsoft.Xrm.Sdk.EntityRole.Referencing);
			}
			set
			{
				this.OnPropertyChanging("Referencingcontact_customer_contacts");
				this.SetRelatedEntity<CrmSvcUtilExtensions.Crm.Entities.Contact>("contact_customer_contacts", Microsoft.Xrm.Sdk.EntityRole.Referencing, value);
		...
		public CrmSvcUtilExtensions.Crm.Entities.Contact Referencingcontact_master_contact
		{
			get
			{
				return this.GetRelatedEntity<CrmSvcUtilExtensions.Crm.Entities.Contact>("contact_master_contact", Microsoft.Xrm.Sdk.EntityRole.Referencing);
			}
		}
	}
	...
	public partial class DataContext : Microsoft.Xrm.Sdk.Client.OrganizationServiceContext
	{
		...
		/// <summary>
		/// Gets a binding to the set of all <see cref="CrmSvcUtilExtensions.Crm.Entities.Contact"/> entities.
		/// </summary>
		public System.Linq.IQueryable<CrmSvcUtilExtensions.Crm.Entities.Contact> ContactSet
		{
			get
			{
				return this.CreateQuery<CrmSvcUtilExtensions.Crm.Entities.Contact>();
			}
		}
	}
}
